...
($P$) monomers, such as constitute present-day proteins, can collapse into relatively compact 
structures with exposed hydrophobic surfaces that can act as primitive catalysts for the elongation 
of other such HP polymers.  Using the HP lattice model, which can explore sequence-space properties 
without bias, we find that such processes are autocatalytic, lead from short chains to longer ones, 
and are sequence selective.  This mechanism may be relevant to the early origins of life.\sout{We 
propose a model for how the random prebiotic polymerization of short 
