...
\section{Flory problem}\label{sec:flory} Production of long oligo-peptides and oligo-nucleotides 
has focused much interests\cite{Shapiro1984,Ferris1996,Kanavarioti2001,Brack2007,Danger2012}.
Results vary. For nucleotides polymerization maximum length reached can range from 10 to 
55\footnote{primary product contains 20-40-mers} nucleotides long depending on conditions 
\cite{Ferris1996,Kanavarioti2001}. For the peptides results are more modest with some experiments 
getting only 2-3mers \cite{Leman2004a} and up to 6 mers \cite{Rode1999}.

The problem is that in the systems with spontaneous polymerization distribution of chain lengths 
of the produced polymers has an exponential asymptote  (see fig. 
\ref{fig:flory}). Depending on the actual system it can can follow for example actual exponential 
