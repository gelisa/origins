...
Correspondingly, it is known that prebiotic polymerizations of amino acids and nucleotides 
lead predominantly to short chains. Leman et al. showed that carbonyl sulfide (COS), a simple 
...
submillimolar or submicromolar concentrations of monomers, longer chains have been expected to be 
present in negligible concentrations~\cite{Aubrey2009,Kanavarioti2001,Lazcano1996}.  The Flory 
...
which the monomer units can be categorized as hydrophobic (H) or polar (P), in particular sequences. 
...
of sequence-structure relationships [  ].  Our studies below lead to two main conclusions.  First, 
...
properties that can explain how prebiotic chemistry might escape the Flory Problem.  

The properties of HP polymers have been studied extensively as a model for the folding and 
...
stably folded structures do not require and a large fraction of the space of random sequences can 
...
\begin{figure}[h!]
  ...
  \caption{\blue{E - let's keep all 4 of them.  But we need thicker lines showing the 
  covalent bonds between beads.  We also need a clearer marker for bead 1: maybe a heavier circle, 
or a different shade of color.} HH interactions are favorable in water, leading to different 
...
\section{The model for HP polymerization kinetics}
 ...
 We consider a soup containing $H$ and $P$ monomers at concentration xxx.  
 A prerequisite for prebiotic origins are processes that are away from equilibrium.  In our case, 
we assume a system in which activated monomers are plentiful, at concentration xxx, and supplied by 
