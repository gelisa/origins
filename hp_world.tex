...
\begin{document}
\abstract{\footnotesize How living systems arose prebiotically from random physico-chemical 
processes is a
...
interdependencies. They make final systems functionally closed and self-sustaining, when out of 
...
how it's possible, botheres many minds. Because functional closeness and self-maintainance are 
prominents properties of life significant amount of research since 1970s was focused on 
...
produces complex dynamics: in all known chemical systems bistability, oscillations or generation of 
waves can be 
explained by one chemical mechanism, and at least one stage of it must be 
autocatalytic\cite{Prigozhin1990}. Production 
of phyical-chemical complexity is one of the steps towards discovering origin of life. 
...
Here are some examples of othero models using autocatalytic sets

 Several studies\cite{Eigen1978,Dyson1985,Kauffman1986} focused on how such self-sustaining 
systems could work if they already exist. They investigated under whic conditions these systems 
indeed are self-maintaining.

In a more recent series of works \cite{segre1998graded,Segre2000,Markovitch2012} 
...
diversity and repllication fidelity.
...
\begin{itemize}
\item The idea of 
autocatalysis was applied by Wu and Higgs\cite{Wu2009} to homo-polymers: while sytem of 
...
Significant progress has been made in attempts to make artificial autocatalytis sets in a 
...
\cite{Ohtsuki2009} model, experience bistability, has semi-periodic fluctuations  
...
constants were 
meausered in terms of it. However mapping one of the constants to lab/prebiotic values fixes the 
rest of the rate 
