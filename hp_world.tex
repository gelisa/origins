...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[]{What molecular structures constitute the autocatalytic set that might produce long 
informational polymers prebiotically?}
...
chains could have led to longer-chain autocatalytic sets of informational polymers.  The essential 
requirement is for polymers of hydrophobic ($H$) and polar ($P$) monomers, such as in present-day 
proteins.\red{I don't see how it is essential}  The principal tool for rigorous study of random 
sequences of such polymers is the $HP$ 
lattice model. \red{2D model can't be called rigorous, only toy}  It is known that a significant 
fraction of random $HP$ sequences can fold into 
relatively structured compact structures.  We show that a significant fraction of those foldamers 
will have clusters of hydrophobic residues on the surface.  For HP polymers, such binding sites can 
help catalyze the elongation of other HP polymers.  A unique aspect of this proposal is that it 
gives specific guidance about what monomer sequences define the autocatalytic set, and a mechanism. 
 
Even in random "soups" of HP chains, enough may be able to fold and provide primitive catalytic 
surfaces to bootstrap the growth of the lengths and informational content of the set.  We believe, 
this 
mechanism is relevant in the early origins of life.}
...
chemical polymerizations.  
 ...
 We first give some background.  Main question we ask in the paper is how the Chemistry-To-Biology 
(CTB) 
 transition might have happened to initiate the earliest life.  Our focus is not on the 
chemical types of monomers and polymer, on on the conditions needed.  Rather, our question here is 
the matter of physical principle of what chemical polymerization processes might lead from random 
to informational chains, from short to long chains, and to autocatalytic sets that could be 
...
% \hline
% Hydrolysis  rate constant & $d_h$ & $\propto 10^{-1}\textendash10^{-4}$ & $\propto 
%1\,month^{-1}-- 
